  ...
  return (
    <div className='main'>
      <div className='lg-upperTitle'>
        <h2>
          Bienvenido a TUTO <span style={{ color: "#F09E00" }}>ACADEMY</span>{" "}
        </h2>
      ...
      <div className='signInButton'>
        <button className='lg-button' onClick={() => login()}>
          ...
          Iniciar sesión con &nbsp;{" "}
          <span style={{ color: "#F09E00" }}>Google</span>
        </button>
      </div>

      <div className='lg-description'>
        <p>
          ¡Bienvenido! Me alegra que estés interesado en conocer más sobre{" "}
          <br />
          Tuto academy web de tutorías académicas. <br /> <br />
          Nuestro sistema de tutorías académicas en línea es la solución
          perfecta <br />
          para aquellos que buscan mejorar sus habilidades académicas <br />
